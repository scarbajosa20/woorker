...
export default class AñadirFormacion extends Component {
    ...
    async obtenerDatos() {
        ...
        .then(response => {
            ...
            console.log(lista)
            // this.setState({nivel:lista.nivel})  
            // this.setState({estudios:lista.estudios})  
            // this.setState({centro:lista.centro})  
            // this.setState({años:lista.años})  
            // this.setState({detalles:lista.detalles})  
